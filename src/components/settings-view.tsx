              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    type="text"
                    placeholder="John"
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg bg-slate-50 focus:bg-white focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-slate-400"
                  />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2 sm:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-lg bg-slate-50 focus:bg-white focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-slate-400"
                    />
                  </div>
                </div>
                <div className="space-y-2 sm:col-span-2">
                ...
                {[
                  {
                    ...
                    desc: "Receive daily transaction summaries via email.",
                    icon: Mail,
                  },
                  {
                    id: "push",
                  ...
                  },
                  {
                    id: "sms",
                    title: "SMS Alerts",
                    desc: "Urgent alerts sent to your phone number.",
                    icon: Smartphone,
                  },
                ].map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <div
                        className={`mt-1 flex items-center justify-center shrink-0 w-5 h-5 rounded border transition-colors ${
          ...
          {activeTab === "security" && (
            <div className="space-y-6 animate-in fade-in slide-in-from-left-2 duration-300">
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                  Protect your account with stronger security.
                </p>
              </div>
              <hr className="border-slate-100 dark:border-slate-800" />
                  ...
                  <div className="space-y-4 max-w-md">
                    <div className="space-y-2">
                      ...
                      <input
                        type="password"
                        placeholder="••••••••"
                        className="w-full px-4 py-2 border border-slate-300 rounded-lg bg-slate-50 focus:bg-white focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all"
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-amber-700/80 dark:text-amber-400/80 mt-1 leading-relaxed">
                        Add an extra layer of security to your account. We will send a verification code to your phone
